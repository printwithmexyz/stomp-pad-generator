...
Phase 0 of the v2 plan packages the previous monolithic
``pyramid_position_calculator.py`` into ``stomppad/``. The implementation
still lives in a single module for now; Phase 1 will split it into
``geometry``, ``packing``, ``patterns``, and ``project`` submodules without
breaking the public re-exports below.
"""
